...
// Baseado nos modelos reais do banco (CSV) vs slugs reais da API
const MODELO_ESPECIAL_MAP = {
  ...
  'FIAT': {
    ...
    'MOBI': 'mobi',
    'PALIO': 'palio',
    'PALIO ADVENTURE': 'palio-adventure',
    'PALIO WEEKEND': 'palio-weekend',
    'PULSE': 'pulse',
    'PULSE ABARTH': 'pulse-abarth',
    'PUNTO': 'punto',
    'SCUDO': 'scudo',
    'SIENA': 'siena',
    'SIENA EL': 'siena-el',
  ...
  'CHEVROLET': {
    ...
    'OMEGA': 'omega',
    'ONIX': 'onix',
    'ONIX ACTIV': 'onix-activ',
    'ONIX JOY': 'onix-joy',
    'ONIX PLUS': 'onix-plus',
    'PRISMA': 'prisma',
    'PRISMA JOY': 'prisma-joy',
    'S10': 's10',
    'SILVERADO': 'silverado',
    'SONIC': 'sonic',
    'SPARK': 'spark',
  ...
  'RENAULT': {
    ...
    'CAPTUR': 'captur',
    'DUSTER': 'duster',
    'DUSTER OROCH': 'duster-oroch',
    'FLUENCE': 'fluence',
    'KANGOO': 'kangoo',
    'KANGOO EXPRESS': 'kangoo-express',
    'KANGOO STEPWAY': 'kangoo-stepway',
    'KARDIAN': 'kardian',
    'KOLEOS': 'koleos',
    'KWID': 'kwid',
    'LOGAN': 'logan',
    'MASTER': 'master',
    'MEGANE': 'megane-e-tech',
  ...
  'MERCEDES-BENZ': {
    ...
    'C': 'c-class', 'C180': 'c-class', 'C200': 'c-class',
    'C250': 'c-class', 'C300': 'c-class',
    'CLA': 'cla', 'CLA200': 'cla', 'CLA250': 'cla',
    'CLS': 'cls',
    'E': 'e-class', 'E200': 'e-class', 'E250': 'e-class',
    'E300': 'e-class', 'E350': 'e-class',
    'EQC': 'eqc', 'EQS': 'eqs',
    'G': 'g-class', 'G63': 'g-class',
  ...
  'PEUGEOT': {
    ...
    '208': '208', '307': '307', '308': '308',
    '406': '406', '407': '407', '408': '408',
    '508': '508', '2008': '2008', '3008': '3008', '5008': '5008',
    'BOXER': 'boxer',
    'EXPERT': 'expert',
    'PARTNER': 'partner',
  },
...
function resolverModeloSlug(marcaSlug, marcaNome, modelo) {
  ...
  if (MODELO_ESPECIAL_MAP[marcaUpper] && MODELO_ESPECIAL_MAP[marcaUpper][modeloUpper] !== undefined) {
    return MODELO_ESPECIAL_MAP[marcaUpper][modeloUpper]; // pode ser null (não mapear)
  }
...
async function buscarMedidasWheelSize({ marca, modelo, ano, versao }) {
  try {
    ...
    // Se o modelo retornou null, não tenta a API (modelo antigo/inexistente)
    if (!modeloSlug) {
      console.log(`[WHEEL-SIZE] Modelo ${modelo} não existe na API, pulando...`);
      return null;
    }
